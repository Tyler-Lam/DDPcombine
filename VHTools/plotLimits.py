...
for m in masses:
    limits = []
    for ct in ctaus:
        f = ROOT.TFile("higgsCombine.VH_m{}_ctau{}_{}.AsymptoticLimits.mH125.root".format(m, ct, year))
    ...
    for v in ['Z']:
        ...
        for l in ['ELE','MU']:
            limits[v][l] = []
            for ct in ctaus:
                f = ROOT.TFile("higgsCombine.{}H_{}_m{}_ctau{}_{}.AsymptoticLimits.mH125.root".format(v,l,m,ct,year))
